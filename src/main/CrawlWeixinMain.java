                ...
                if (indexMsgList != -1 && indexSeajs != -1) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < listArray.length(); i++) {
                            ...
                            String appMsgExtInfoStr = listObj.getString("app_msg_ext_info");
                            // System.out.println("app_msg_ext_info_Str : " +
                            // app_msg_ext_info_Str);

                            JSONObject appObj = new JSONObject(appMsgExtInfoStr);
                            ...
                            String multiAppMsgItemListStr = appObj.getString("multi_app_msg_item_list");
                            // System.out.println("multi_app_msg_item_list_Str :
                            // "+multi_app_msg_item_list_Str);
                            JSONArray multiArray = new JSONArray(multiAppMsgItemListStr);
